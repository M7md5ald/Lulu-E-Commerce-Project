  ...
  <div class="sidebar-nav" data-simplebar="true">
    ...
    <ul class="metismenu" id="sidenav">
      ...
      <li>
        ...
        <ul>
          <li><a href="{{route('products.create')}}"><i class="material-icons-outlined">arrow_right</i>Create</a>
          </li>
          <li><a href="{{route('products.view')}}"><i class="material-icons-outlined">arrow_right</i>View</a>
          </li>
