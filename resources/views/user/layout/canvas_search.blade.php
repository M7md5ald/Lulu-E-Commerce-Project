                    ...
                    <div class="tf-col-content">
                        ...
                        <div class="tf-search-hidden-inner">
                            <div class="tf-loop-item">
                                <div class="image">
                                    <a href="product-detail.html">
                                        <img src="{{asset('frontend')}}/assets/images/products/white-3.jpg" alt="">
                                    </a>
                                </div>
                                <div class="content">
                            ...
                            <div class="tf-loop-item">
                                <div class="image">
                                    <a href="product-detail.html">
                                        <img src="{{asset('frontend')}}/assets/images/products/white-2.jpg" alt="">
                                    </a>
                                </div>
                                <div class="content">
                            ...
                            <div class="tf-loop-item">
                                <div class="image">
                                    <a href="product-detail.html">
                                        <img src="{{asset('frontend')}}/assets/images/products/white-1.jpg" alt="">
                                    </a>
                                </div>
                                <div class="content">
