                                ...
                                <div id="sub-product-four" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        ...
                                        <li><a href="product-{{asset('frontend')}}/assets/images-grouped.html"
                                                class="sub-nav-link">Variant {{asset('frontend')}}/assets/images
                                                grouped</a></li>
            ...
            <div class="bottom-bar-language">
                <div class="tf-currencies">
                    <select class="image-select center style-default type-currencies">
                        <option data-thumbnail="{{asset('frontend')}}/assets/images/country/fr.svg">EUR <span>€ |
                                France</span></option>
                        <option data-thumbnail="{{asset('frontend')}}/assets/images/country/de.svg">EUR <span>€ |
                                Germany</span></option>
                        <option selected data-thumbnail="{{asset('frontend')}}/assets/images/country/us.svg">USD
                            <span>$ | United States</span>
                        </option>
                        <option data-thumbnail="{{asset('frontend')}}/assets/images/country/vn.svg">VND <span>₫ |
                                Vietnam</span></option>
                    </select>
                </div>
