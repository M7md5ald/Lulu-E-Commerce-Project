        ...
        <div class="row wrapper-header align-items-center">
                                            ...
                                            <a href="index.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{asset('frontend')}}/assets/images/demo/home-01.jpg"
                                                        alt="home-01">
                                            ...
                                            <a href="home-02.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{asset('frontend')}}/assets/images/demo/home-02.jpg"
                                                        alt="home-02">
                                                    <div class="demo-label">
                                                        <span class="demo-hot">Hot</span>
                                                    </div>
                                            ...
                                            <a href="home-03.html">
                                                <div class="demo-image">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{asset('frontend')}}/assets/images/demo/home-03.jpg"
                                                        alt="home-03">
                                                </div>
                                            ...
                                            <a href="home-04.html">
                                                <div class="demo-image">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{asset('frontend')}}/assets/images/demo/home-04.jpg"
                                                        alt="home-04">
                                                </div>
                                            ...
                                            <a href="home-05.html">
                                                <div class="demo-image">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{asset('frontend')}}/assets/images/demo/home-05.jpg"
                                                        alt="home-05">
                                                </div>
                                            ...
                                            <a href="home-06.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{asset('frontend')}}/assets/images/demo/home-06.jpg"
                                                        alt="home-06">
                                                    <div class="demo-label">
                                                        <span class="demo-new">New</span>
                                                    </div>
                                            ...
                                            <a href="home-07.html">
                                                <div class="demo-image">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{asset('frontend')}}/assets/images/demo/home-07.jpg"
                                                        alt="home-07">
                                                </div>
                                            ...
                                            <a href="home-08.html">
                                                <div class="demo-image">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{asset('frontend')}}/assets/images/demo/home-08.jpg"
                                                        alt="home-08">
                                                </div>
                                            ...
                                            <div class="mega-menu-item">
                                                ...
                                                <ul class="menu-list">
                                                    ...
                                                    <li><a href="shop-loadmore.html"
                                                            class="menu-link-text link">Pagination loadmore</a>
                                                    </li>
                                            ...
                                            <div class="mega-menu-item">
                                                ...
                                                <ul class="menu-list">
                                                    <li><a href="product-style-list.html"
                                                            class="menu-link-text link">Product style list</a>
                                                    </li>
                                            ...
                                            <div class="collection-item hover-img">
                                                <div class="collection-inner">
                                                    <a href="shop-men.html" class="collection-image img-style">
                                                        <img class="lazyload"
                                                            data-src="{{asset('frontend')}}/assets/images/collections/collection-1.jpg"
                                                            src="{{asset('frontend')}}/assets/images/collections/collection-1.jpg"
                                            ...
                                            <div class="collection-item hover-img">
                                                <div class="collection-inner">
                                                    <a href="shop-women.html"
                                                        ...
                                                        <img class="lazyload"
                                                            data-src="{{asset('frontend')}}/assets/images/collections/collection-2.jpg"
                                                            src="{{asset('frontend')}}/assets/images/collections/collection-2.jpg"
                                                            alt="collection-demo-1">
                                                    </a>
                                                    <div class="collection-content">
                                                        <a href="shop-women.html"
                                        ...
                                        <div class="col-lg-2">
                                            <div class="mega-menu-item">
                                                ...
                                                <ul class="menu-list">
                                                    ...
                                                    <li><a href="product-{{asset('frontend')}}/assets/images-grouped.html"
                                                            class="menu-link-text link">Variant
                                                            {{asset('frontend')}}/assets/images grouped</a></li>
                                                                ...
                                                                <div class="card-product-wrapper">
                                                                    <div class="product-img">
                                                                        <img class="lazyload img-product"
                                                                            ...
                                                                            src="{{asset('frontend')}}/assets/images/products/white-3.jpg"
                                                                            alt="image-product">
                                                                        <img class="lazyload img-hover"
                                                                            data-src="{{asset('frontend')}}/assets/images/products/white-4.jpg"
                                                                            src="{{asset('frontend')}}/assets/images/products/white-4.jpg"
                                                                            alt="image-product">
                                                                    </div>
                                                                    <div class="list-product-btn absolute-2">
                                                                        <a href="#shoppingCart"
                                                                ...
                                                                <div class="card-product-wrapper">
                                                                    <div class="product-img">
                                                                        ...
                                                                        <img class="lazyload img-hover"
                                                                            ...
                                                                            src="{{asset('frontend')}}/assets/images/products/brown-3.jpg"
                                                                            alt="image-product">
                                                                    </div>
                                                                    <div class="size-list">
                                                                        <span>S</span>
            ...
            <div class="col-xl-3 col-md-4 col-3">
                <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                    ...
                    <li class="nav-cart"><a href="{{ route('user.cart.show') }}" class="nav-icon-item"><i
