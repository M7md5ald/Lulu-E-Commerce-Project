            ...
            <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                <li class="nav-mb-item">
                    <a href="shop-default.html" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{asset('frontend')}}/assets/images/shop/cate/cate1.jpg" alt="">
                        </div>
                ...
                <li class="nav-mb-item">
                    <a href="shop-default.html" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{asset('frontend')}}/assets/images/shop/cate/cate2.jpg" alt="">
                        </div>
                        <span>Dog</span>
                    </a>
                </li>
                <li class="nav-mb-item">
                    <a href="shop-default.html" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{asset('frontend')}}/assets/images/shop/cate/cate3.jpg" alt="">
                        </div>
                        <span>Grocery</span>
                    </a>
                </li>
                <li class="nav-mb-item">
                    <a href="shop-default.html" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{asset('frontend')}}/assets/images/shop/cate/cate4.png" alt="">
                        </div>
                        <span>Handbag</span>
                    </a>
                </li>
                <li class="nav-mb-item">
                    <a href="#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link"
                        ...
                        <div class="image">
                            <img src="{{asset('frontend')}}/assets/images/shop/cate/cate5.jpg" alt="">
                        </div>
                        <span>Fashion</span>
                        ...
                        <ul class="sub-nav-menu" id="cate-menu-navigation">
                            <li>
                                <a href="#cate-shop-one"
                                    ...
                                    <div class="image">
                                        <img src="{{asset('frontend')}}/assets/images/shop/cate/cate6.jpg" alt="">
                                    </div>
                                    <span>Mens</span>
                                    <span class="btn-open-sub"></span>
                                </a>
                                    ...
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        <li>
                                            <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                <div class="image">
                                                    <img src="{{asset('frontend')}}/assets/images/shop/cate/cate1.jpg"
                                                        alt="">
                                                </div>
                                                <span>Accessories</span>
                                            </a>
                                        ...
                                        <li>
                                            <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                <div class="image">
                                                    <img src="{{asset('frontend')}}/assets/images/shop/cate/cate8.jpg"
                                                        alt="">
                                                </div>
                                                <span>Shoes</span>
                                            </a>
                            ...
                            <li>
                                <a href="#cate-shop-two"
                                    ...
                                    <div class="image">
                                        <img src="{{asset('frontend')}}/assets/images/shop/cate/cate9.jpg" alt="">
                                    </div>
                                    <span>Womens</span>
                                    <span class="btn-open-sub"></span>
                                </a>
                                <div id="cate-shop-two" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        <li>
                                            <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                <div class="image">
                                                    <img src="{{asset('frontend')}}/assets/images/shop/cate/cate4.png"
                                                        alt="">
                                                </div>
                                                <span>Handbag</span>
                                            </a>
                                        ...
                                        <li>
                                            <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                <div class="image">
                                                    <img src="{{asset('frontend')}}/assets/images/shop/cate/cate7.jpg"
                                                        alt="">
                                                </div>
                                                <span>Tee</span>
                                            </a>
                    ...
                    <div id="cate-menu-two" class="collapse list-cate">
                        <ul class="sub-nav-menu" id="cate-menu-navigation1">
                            ...
                            <li>
                                <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                    <div class="image">
                                        <img src="{{asset('frontend')}}/assets/images/shop/cate/cate8.jpg" alt="">
                                    </div>
                                    <span>Shoes</span>
                                </a>
                            </li>
                ...
                <li class="nav-mb-item">
                    <a href="shop-default.html" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{asset('frontend')}}/assets/images/shop/cate/cate7.jpg" alt="">
                        </div>
                        <span>Tee</span>
                    </a>
                </li>
